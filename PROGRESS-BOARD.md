...
> 최종 갱신: 2026-06-24 · 현재 작업: **미팅 후 방향 결정 대기**
...
| # | 무엇 | 상태 |
|---|------|------|
| 1 | **UIUX 수정** — 프롬프트 기반 (Michael이 제공 예정) | ⬜ 대기 |
| 2 | **데이터 계층 수정** — kind 2→3분류 (slide/layout/component). [스펙](docs/superpowers/specs/2026-06-23-kind-three-way-classification-design.md) 완료 | ⬜ |
| 3 | **Scratch 삽입** — 에셋을 흑백/뼈대 형태로 삽입, 스타일 탭에서 나중에 컨셉 적용 | ⬜ |
