...
> 최종 갱신: 2026-06-23 · 현재 작업: **태스크 큐 — #1.5 에셋 탭 Supabase 연동 (다음 세션)**
...
| # | 무엇 | 상태 |
|---|------|------|
| 1.5 | **에셋 탭 Supabase 연동** — 로컬 하드코딩 제거, Supabase assets 테이블에서 전체 에셋을 category별로 불러와 표시. RemoteAssetCache로 pptx/thumb 다운로드+삽입 | ⬜ 다음 |
| 2 | **UIUX 수정** — 프롬프트 기반 (Michael이 제공 예정) | ⬜ 대기 |
